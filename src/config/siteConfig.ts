...
export const siteConfig: SiteConfig = {
	title: "Mu",
	subtitle: "A website",
	siteURL: "https://blog-h8lg.vercel.app/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2025-08-30", // 站点开始运行日期，用于站点统计组件计算运行天数
	timeZone: "Asia/Tokyo", // 文章日期使用的 IANA 时区，可改为 Asia/Tokyo、Europe/Berlin 等
	...
	banner: {
		...
		homeText: {
			...
			subtitle: [
				"สบายดี หรู? ดีใจที่คุณมา.",
				"書きます。  たぶん。",
				"ni li pona sama toki pona!",
				"Bedaŭrinde, ĝi ne subtenas Esperanton.",
				"なかなかそれっぽくできたんじゃない？",
			],
			typewriter: {
